...
const AligoKakaSdk_type_1 = require("./types/AligoKakaSdk.type");
...
class AligoKakaoSDK {
    ...
    getToken(lifetimeMs = 1000 * 30) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield Common_utils_1.CommonUtil.sendFormPost(`https://kakaoapi.aligo.in/akv10/token/create/${lifetimeMs}/s`, {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (res.code === 0) {
                ...
                return isPlainToInstance
                    ? (0, class_transformer_1.plainToInstance)(AligoKakaSdk_type_1.Template, templates, {
    ...
    getMessageHistoryPage(startDate, endDate, page = 1, limit = 500, isPlainToInstance = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (res.code === 0) {
                ...
                return isPlainToInstance
                    ? (0, class_transformer_1.plainToInstance)(AligoKakaSdk_type_1.MessageHistoryPage, messageHistoryPage, {
                        excludeExtraneousValues: true
                    })
                    : messageHistoryPage;
            }
    ...
    getMessageHistoryDetailPage(mid, page = 1, limit = 50, isPlainToInstance = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (res.code === 0) {
                ...
                return isPlainToInstance
                    ? (0, class_transformer_1.plainToInstance)(AligoKakaSdk_type_1.MessageHistoryDetailPage, messageHistoryDetailPage, {
                        excludeExtraneousValues: true
                    })
    ...
    sendMessage(template, messages, options, isPlainToInstance = true) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.tokenCheck();
            const body = Object.assign(Object.assign({ token: this.token.content, apikey: this.config.key, userid: this.config.userId, sender: this.config.sender, senderkey: this.config.senderKey, tpl_code: template.templtCode }, Aligo_utils_1.AligoUtil.createMessageBody(template, messages)), options);
            ...
            if (res.code === 0) {
                ...
                return isPlainToInstance
                    ? (0, class_transformer_1.plainToInstance)(AligoKakaSdk_type_1.SentMessageInfo, sentMessageInfo, {
                        excludeExtraneousValues: true
                    })
                    : sentMessageInfo;
            }
